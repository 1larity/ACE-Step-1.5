...
"""ACE-Step v1.5 base model components and conditioned generation modules."""
...
class AceStepPreTrainedModel(PreTrainedModel):
    """Base pretrained model wrapper for ACE-Step base checkpoints."""
...
def test_forward(model, seed=42):
    ...
    """Run a lightweight forward smoke test for the base model."""
    import random
    import numpy as np
    random.seed(seed)
    np.random.seed(seed)
