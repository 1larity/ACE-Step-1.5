...
DEFAULT_LM_REWRITE_INSTRUCTION = (
    ...
    "If the caption is only a short fragment or keyword list, expand it into a complete "
    "ACE-Step narrative caption with global musical traits first and a clear song arc after that:"
)
