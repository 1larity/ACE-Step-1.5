...
DEFAULT_LM_INSPIRED_INSTRUCTION = (
    ...
    "explicitly including singer gender and delivery mood when vocals are present:"
)
DEFAULT_LM_REWRITE_INSTRUCTION = (
    "Format the user's input into a more detailed and specific musical description. "
    "If the caption is only a short fragment or keyword list, expand it into a "
    "complete ACE-Step narrative caption with global musical traits first and a "
    "clear song arc after that, explicitly including singer gender and delivery "
    "mood when vocals are present:"
)
